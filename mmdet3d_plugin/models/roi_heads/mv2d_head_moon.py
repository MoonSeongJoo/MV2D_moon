...
class MV2DHead_moon(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    def __init__(self,
                 bbox_roi_extractor,
                 bbox_head,
                 query_generator,
                 ...
                 test_cfg=None,
                 **kwargs):
        super(MV2DHead_moon, self).__init__(bbox_roi_extractor=bbox_roi_extractor, bbox_head=bbox_head,
