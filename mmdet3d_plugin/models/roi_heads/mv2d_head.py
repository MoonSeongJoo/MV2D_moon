...
class MV2DHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def _bbox_forward_train(self, img,lidar_depth_mis,x, depth_x, proposal_list, img_metas,points_gt,gt_KT,mis_RT): # for SJMOON
    # def _bbox_forward_train(self, x, proposal_list, img_metas): # for original 
        """Run forward function and calculate loss for box head in training."""

        bbox_results,loss_corr = self._bbox_forward(img,lidar_depth_mis,x, depth_x, proposal_list,img_metas,points_gt,gt_KT,mis_RT) # for SJMOON
