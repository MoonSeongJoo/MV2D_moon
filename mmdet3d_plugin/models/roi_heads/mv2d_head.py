...
class MV2DHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    # def _bbox_forward_train(self, x, proposal_list, img_metas): # for original 
        ...
        bbox_results ,total_loss_corr,loss_corr = self._bbox_forward(img,img_metas,lidar_depth_mis,x, proposal_list,uvz_gt,mis_KT,mis_Rt,gt_KT,gt_KT_3by4) # for SJMOON
        ...
        return bbox_results, total_loss_corr, loss_corr
        # return bbox_results
