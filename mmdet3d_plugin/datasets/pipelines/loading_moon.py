...
class PointToMultiViewDepth(object):
    ...
    def __call__(self, results):
        ...
        for cid in range(len(results['lidar2img'])):
            ...
            miscalibrated_points2img , extrinsic_perturb, lidar2img_original ,lidar2img_mis = add_mis_calibration_adv(lidar2img,lidar2cam,cam2img, points_lidar, max_r=2.0,max_t=0.2)
